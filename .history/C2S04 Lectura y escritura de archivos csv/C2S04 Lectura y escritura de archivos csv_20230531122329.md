Claro, a continuación te presento las notas para una clase sobre lectura y escritura de archivos CSV usando pandas, con el archivo `test.csv` del dataset del Titanic de Kaggle.
